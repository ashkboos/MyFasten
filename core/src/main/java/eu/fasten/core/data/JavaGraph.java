...
public class JavaGraph {
     ...
     */
    private final Map<LongLongPair, Map<Object, Object>> callSites;
     ...
     */
    public JavaGraph(final Map<LongLongPair, Map<Object, Object>> callSites) {
        this.callSites = callSites;
    }

    public void put(LongLongPair key, Map<Object, Object> value) {
     ...
     */
    public JavaGraph(final HashMap<LongLongPair, Map<Object, Object>> callSites) {
        this.callSites = callSites;
    }
     ...
     * @return call map
     */
    public Map<LongLongPair, Map<Object, Object>> getCall(final JSONArray call) {
        ...
        return Map.of(LongLongPair.of(Long.parseLong(call.getString(0)),
            Long.parseLong(call.getString(1))), callSite);
    }
     ...
     */
    private Map<LongLongPair, Map<Object, Object>> extractCalls(JSONArray calls) {
        final Map<LongLongPair, Map<Object, Object>> result = new HashMap<>();
    ...
    public Map<Object, Object> getOrDefault(LongLongPair call, Map<Object, Object> metadata) {
        return this.callSites.getOrDefault(call, metadata);
    }

    public Map<Object, Object> get(LongLongPair key) {

...
public class OPALType {
     ...
     */
    public static Pair<Map<String, JavaNode>, Long2ObjectMap<JavaNode>> getMethodMaps(final Map<Method,
            Integer> methods) {
        final Long2ObjectMap<JavaNode> nodes = new Long2ObjectOpenHashMap<>();
     ...
     * @return Map of Nodes
     */
    public static Long2ObjectMap<JavaNode> toURIDeclaredMethods(
            final Map<DeclaredMethod, Integer> methods) {
        final Long2ObjectMap<JavaNode> result = new Long2ObjectOpenHashMap<>();

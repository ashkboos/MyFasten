...
class OPALClassHierarchyTest {
    ...
    void getInternalCallKeys() {
        ...
        assertEquals(123, internalKeys.firstLong());
        assertEquals(234, internalKeys.secondLong());
    }
    ...
    void getExternalCallKeysSourceMethodTargetDeclaredMethod() {
        ...
        assertEquals(123, externalKeys.firstLong());
        assertEquals(5, externalKeys.secondLong());
    }
    ...
    void getExternalCallKeysSourceDeclaredMethodTargetMethod() {
        ...
        assertEquals(5, externalKeys.firstLong());
        assertEquals(123, externalKeys.secondLong());
    }
    ...
    void getExternalCallKeysSourceDeclaredMethodTargetDeclaredMethod() {
        ...
        assertEquals(5, externalKeys.firstLong());
        assertEquals(6, externalKeys.secondLong());
    }
    ...
    void getExternalCallKeysWrongTypes() {
        ...
        assertEquals(LongLongPair.of(-1,-1), classHierarchy.getExternalCallKeys(new Object(),
            new Object()));
    }
    ...
    void getExternalCallKeysSourceMethodTargetWrongType() {
        ...
        assertEquals(LongLongPair.of(-1,-1), classHierarchy.getExternalCallKeys(source,
            new Object()));
    }
    ...
    void putCallsSourceDeclaredMethod() {
        ...
        var calls = new JavaGraph();
        calls.put(LongLongPair.of(5, 6), new HashMap<>());
        ...
        assertEquals(0, calls.get(LongLongPair.of(5, 6)).size());
        ...
        assertEquals(1, calls.get(LongLongPair.of(5, 6)).size());
        assertEquals("newMetadata", calls.get(LongLongPair.of(5, 6)).get(10));
    }
    ...
    void putCallsTargetConstructor() {
        ...
        assertEquals("newMetadata", calls.get(LongLongPair.of(5, 6)).get(10));
        assertNull(calls.get(LongLongPair.of(6, 6)));
    }
    ...
    void getInternalMetadata() {
        var callKeys = LongLongPair.of(1,2);
